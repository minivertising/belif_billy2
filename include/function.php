<?
	...
	function send_lms2($phone)
	{
		...
		$response = sendRequest3($httpmethod, $url, $clientKey, $contentType, $phone);
...
매장 관련 : 080-023-7007 (평일 10~18시)"
	...
	function sendRequest3($httpMethod, $url, $clientKey, $contentType, $phone) {
		...
		$params = array(
			...
			'msg_body' => "
안녕하세요.
VDL COMMENT EVENT 시스템 오류로 인하여 잘못된 수신번호로 당첨 문자를 전송해 드렸습니다.
죄송합니다.
"
);
